        ...
        <div className="min-h-screen flex flex-col items-center"
            ...
            <div className="w-full max-w-xl px-4 py-8">
                <div className="flex justify-between items-center mb-6">
                    ...
                    {isSignedIn && (
                        <button onClick={handleSignOut} className="btn btn-sm" style={primaryButtonStyle}
                        >
                            Sign Out
                        </button>
                    )}
                ...
                <div className="flex gap-2 mb-6">
                    <button onClick={() => navigate("/")} className="btn" style={primaryButtonStyle}
                    >
                        Home
                    </button>
                    <button onClick={() => navigate("/tier")} className="btn" style={primaryButtonStyle}
                    >
                        Go to TierList
                    </button>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button type="submit" className="btn w-full" style={primaryButtonStyle} disabled={loading}
                        >
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex flex-col gap-2">
                        <button onClick={deleteAccount} className="btn w-full" style={primaryButtonStyle} disabled={loading}
                        >
                            {loading ? "Processing..." : "Delete Account"}
                        </button>
                        <button onClick={deleteInfo} className="btn w-full" style={primaryButtonStyle}
                        >
                            Delete Info
                        </button>
                    </div>
